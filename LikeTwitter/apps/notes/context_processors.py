...
def random_note(request):
    ...
    random_note_full_url = (u"""<div id="random_note" url="%s/"></div><script type="text/javascript"
        language="javascript" src="%s%sjs/random_note.js"></script>""" % (site, site, static_url))
    random_note_local_url = mark_safe(u"""<div id="random_note" url=""></div><script type="text/javascript"
