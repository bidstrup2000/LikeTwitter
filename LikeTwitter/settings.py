...
MEDIA_ROOT = os.path.join(PROJECT_DIR, 'apps/notes/media/')
...
SECRET_KEY = '27lw$u3_u9g21f0h3brl=f)4+y3t2wn70u2)77p0&3(twuatn1'
...
ROOT_URLCONF = 'LikeTwitter.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'LikeTwitter.wsgi.application'

TEMPLATE_DIRS = (
    "/apps/notes/templates"
